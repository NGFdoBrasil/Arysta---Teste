function createDataset(fields, constraints, sortFields) {
    ...
    var codPrograma = findConstraint("appMain",constraints,""); 
    log.info("@@@ CONSTRAINT 1234 : "+ codPrograma );
    ...
    dataset.addColumn("appRisco");
    
    var c = DatasetFactory.createConstraint("appMain", codPrograma ,codPrograma, ConstraintType.MUST);
     
    
   var  datasetPrincipal= DatasetFactory.getDataset("CadastroConflitos", null, [c], null)
        	...
        	if (datasetFilhos.getValue(j, "aplicativo") != '' 
             ...
             && datasetFilhos.getValue(j, "aplicativo") != 'undefined'){
	            dataset.addRow([
	                ...
	                appMainObs,
	                datasetFilhos.getValue(j, "aplicativo"),
	                datasetFilhos.getValue(j, "appRisco")
	            ]); 
        	}
        }
    }
